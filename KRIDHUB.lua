...
-- FORSAKEN
window:AddScriptTab("FORSAKEN", "ยินดีต้อนรับสู่ KRIDHUB\nสคริปต์นี้คือสคริปต์แมพ FORSAKEN\nพัฒนาโดย: KRIDHUB\nเวอร์ชันสคริปต์: 7.1.5", "https://raw.githubusercontent.com/XDLua/Scripts/refs/heads/main/Forsaken.lua")
window:AddScriptTab("ADMIN", "Infinite Yield", "สคริปต์ยอดนิยมสำหรับแอดมิน", "https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source")
